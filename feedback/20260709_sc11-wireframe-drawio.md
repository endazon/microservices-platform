...
status: open
category: UC/画面の差異
related_ids: [FR-15, SC-11]
source_repo: microservices-platform
source_ref: "docs/screens/SC-11_configuration-viewer.md（未決事項5）/ IADR-0036 / IADR-0046"
author: claude
created: 2026-07-09
---
...
- 履歴のデータ源も [[IADR-0046]]（#139）で GitOps 層に確定し、画面の情報要素（コミット ID・適用日時・
  適用者・ドリフト有無）が固まった。ワイヤーフレームはこれを反映できる状態。
...
- 反映後、実装側 `docs/screens/SC-11_configuration-viewer.md` 未決事項 5 を「解決済み」へ更新する（本リポジトリ側の追随作業）。
