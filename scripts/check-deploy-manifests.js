 ...
 *    （[IADR-0239]。#783 前半の実測。2026-08-21 版の本スクリプトは helm lint / helm template /
 ...
 *    `datreeio/CRDs-catalog`（[IADR-0239]で選定・実測確認済み）で解決する。**未知の CRD で
...
/**
 * kubeconform のスキーマ供給元（[IADR-0239]）。
