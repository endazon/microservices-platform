...
| `static-checks`（再掲） | `check-realm-constraints.js --self-test` と本検査（#18 / #307 / #385 / #1144。**#1144 で「dev 既定の送出先が捕捉用 MTA であること」の門が加わった** —— realm の静的既定と Vault seed の既定の**両方**を見る。片方だけ直しても、もう片方から外へ出る） |
