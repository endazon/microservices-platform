...
# NFR-09, ADR-0011/ADR-0026, IADR-0095/IADR-0328/IADR-0333 (#1127): Wiki.js の Keycloak OIDC
...
#
# NFR-09, IADR-0333 (#1127): 同じ bootstrap の **段 8** が Keycloak OIDC ストラテジ
...
wikijs_oidc_note=""
[ "${WIKIJS_OIDC:-}" = "1" ] && wikijs_oidc_note=" ＋ [opt-in] OIDC ストラテジ投入（IADR-0333）"
