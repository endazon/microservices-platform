 ...
 *   と定めている。ADR-0035（本スクリプト作成時点〔2026-08-05〕の状態は Proposed。**2026-08-07 に
 *   Accepted へ移った** ＝ planning 3e58b97 = PR planning#244〔裁定依頼 planning#237〕・#586）は planning#187 の裁定（案 B）により
 *   実測を待たずに「機密区分単位から始める」と決定済みだが、同裁定は
