...
- Issue: #229（step3・第2ドメイン=Analysis）。第1ドメイン DataSource は #247（[[20260711_issue-229_migrate-datasource-bff]]）で完了。

## 目的・背景

[[IADR-0063]] step3 の 2 ドメイン目。**Analysis** の BFF エンドポイント集約と DTO を platform から knowledge
