...
**初回実装では、当時の 6 本のうち 3 本が dead code だった** ——
...
**是正**: 3 本の呼び出しをブロックの**外**へ移し、**untracked のファイルを実際に作って 1 本ずつ観測**した（下記）。
...
| 6 | `scripts/scripts.repo.test.js`（回帰テスト 6 件） | 300,988 | 313,308 | **＋12,320** |
| 7 | `docs/DEFINITION_OF_DONE.md`（検証の順序） | 4,769 | 6,513 | **＋1,744** |
| 8 | `docs/adr/IADR-0183_...md`（新規） | 0 | 10,758 | **＋10,758** |
| 9 | `docs/adr/README.md`（索引 1 行） | 216,744 | 217,226 | **＋482** |
| 10 | `docs/specs/20260811_issue-683_...md`（本書・新規） | 0 | 17,019 | **＋17,019** |
| | **計** | | | **＋50,681** |
