...
- **NFR**（障害検出 5 分以内）。計画 ADR: **ADR-0006**。
...
| **b**: `k8s-local-up-smoke` 相当へ足す | **不可**。`kubectl` が無く、クラスタも無い | **採れない** |
