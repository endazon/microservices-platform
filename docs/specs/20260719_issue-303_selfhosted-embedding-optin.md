...
plan_refs:
  ...
  - "../../planning/projects/microservices-platform/07_adr/ADR-0017_embedding-selfhosted-ruri.md (ティアA=セルフホスト Ruri v3)"
related_specs:
...
現状索引されない**ことが検出された（Medium）。設計上は正しい fail-closed（[[IADR-0025]]／ADR-0017）だが、
