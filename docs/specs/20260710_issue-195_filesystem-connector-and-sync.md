...
- 関連 ADR: ADR-0003（MassTransit）、[[IADR-0019]]（データソース既定属性）、[[IADR-0051]]（本 PR で作成）
- Issue: #195
...
- 対象:
  ...
  - ドキュメント: 本仕様書・[[IADR-0051]]・`docs/functional/FR-01`・`docs/tests/FR-01`。
