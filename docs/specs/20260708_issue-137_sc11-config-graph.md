...
- 画面（SC）: SC-11 構成ビューア
- 関連 ADR: ADR-0018（Composable Architecture）／ [[IADR-0029]]（構成情報 API・ドリフト）／ [[IADR-0030]]（ConfigViewer）／ [[IADR-0033]]（SPA 基盤）／ [[IADR-0034]]（ロール別 nav・存在秘匿）／ **[[IADR-0035]]（可視化方式・新規）**
- Issue: #137（親 #122）
...
SC-11 仕様書の**未決事項 4（グラフレイアウト）を解決**する（[[IADR-0035]]）。
...
- 対象:
  ...
  - 未決事項 4 の解決（[[IADR-0035]]）と SC-11 仕様書の更新。
