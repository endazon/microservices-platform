...
related_adrs:
  - ../adr/IADR-0019_transitive-vulnerability-scan.md
related_prs:
  - "#61"
...
- `.github/workflows/security.yml`
  ...
  - `vulnerable-scan` ジョブを追加（restore → `dotnet list package --vulnerable --include-transitive` →
    深刻度検出で `exit 1`）。
- `docs/adr/IADR-0019_transitive-vulnerability-scan.md`（本作業の実装判断）。
- `docs/adr/README.md` の一覧へ IADR-0019 を追記。
...
- **#61（IADR-0016）のマージ順序**: 本 IADR は #61 が採番する IADR-0016 の後継として IADR-0019 を用いる。
