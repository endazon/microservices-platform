...
- 関連 ADR: [[IADR-0051]]（定期同期ワーカー本体）／[[IADR-0074]]（Helm 配線・本番有効化。決定 4 で単一書き手化を本 issue へ先送り）
- 本作業の設計判断: [[IADR-0083]]
...
- 排他方式の選定理由・トレードオフ（k8s Lease 却下・トランザクションプーラ非対応の注意）は [[IADR-0083]] に記録。
