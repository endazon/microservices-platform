...
specs: [20260707_FR-15_config-info-api-introspection-drift, 20260708_issue-113_sc11-open-items-operator-role, 20260911_issue-1382_drift-timeout-stops-host, 20260926_1514_introspection-grpc-fanout, 20260926_1537_conversion-introspection-grpc-wiring, 20260927_issue-1630_caller-cancel-controls-tce]
issues: [#444, #1382, #1514, #1255, #1537, #1630]
-->
...
| 2i | 自己申告の REST の収集 | 応答した宛先は実効構成と到達済みへ・1 宛先の失敗・期限切れ・空本文・不正な JSON は到達不能へ隔離して他を続ける・呼び出し側の取り消しは到達不能へ畳まず外へ出す（取り消しは本物の HTTP クライアントをループバックの応答しない待受へつないで起こし、期限切れと同じ型の例外で届くことを前提として表明する。［2026-09-27 追加］） | `…/Introspection/HttpEffectiveConfigCollectorTests` |
