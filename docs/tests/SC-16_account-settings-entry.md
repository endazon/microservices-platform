...
> （[05_screens §共通シェル](../../planning/projects/microservices-platform/05_screens/01_screens.md)
...
- 関連 ADR: [ADR-0031](../../planning/projects/microservices-platform/07_adr/ADR-0031_frontend-stack.md)（SPA スタック）／
  [IADR-0124](../adr/IADR-0124_tanstack-router-unit-composition.md)（共通シェルの実装範囲）
...
- 第 3 段（#439 / [ADR-0032](../../planning/projects/microservices-platform/07_adr/ADR-0032_spa-auth-bff-session.md)）で
