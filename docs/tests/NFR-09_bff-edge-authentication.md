...
> **★ T-20 の SC-03 は当初「403 でも 401 でもない」という弱い主張にしていた。**
...
| E: 文書読み取り群へ**誤って**ロールを足す（`AdminOnly`） | T-20 の SC-03 3 件 ＋ T-21（運用者 200） |
| F: SC-03 の詳細を**常に 404 へ倒す**（静かに壊れる） | T-20 の SC-03 3 件。**弱い主張のままなら素通りしていた** |
