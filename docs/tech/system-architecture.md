...
- ADR: ADR-0001（マイクロサービス採用）、ADR-0002（サービス境界・Database per Service。実装で 11 サービス確定）、ADR-0003（MassTransit/RabbitMQ。Superseded by ADR-0027）、ADR-0004（ABAC 認可）、ADR-0009（ベクトル DB=Qdrant）、ADR-0010（LLM ゲートウェイ）、ADR-0011（Wiki エンジン）、ADR-0018（コンポーザブル）、ADR-0019（ユニット第一構成）
