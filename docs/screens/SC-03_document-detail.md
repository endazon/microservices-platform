...
| 10 | 右レール「AIチャットパネル」（437-442） | **しない** | 共通シェルの要素。移行**第 4 段**（[[IADR-0121]] 決定 5） |
| 11 | パンくず「ホーム / 検索結果 / …」（413） | **しない** | 共通シェルの要素。#452 |
| 12 | 左ナビの「文書詳細」項目（414） | **しない** | §左ナビに出さない理由 |
...
表示名は計画へ環流する（[feedback/20260804_sc01-03-bff-contract-gaps.md](../../feedback/20260804_sc01-03-bff-contract-gaps.md)）。
...
3. **機密区分の表示名**（4 値のうち 2 値しか計画に現れない）。環流済み。
