...
| 12 | **共通シェル**: 左ナビの「文書詳細」項目（414） | **しない** | §左ナビに出さない理由（**計画 §共通シェル は SC-03 を「利用者」グループに挙げているため、環流の記録へ 1 項目として載せた**） |
...
表示名は環流の記録に載せた（[feedback/20260804_sc01-03-bff-contract-gaps.md](../../feedback/20260804_sc01-03-bff-contract-gaps.md)。
**計画リポジトリへの起票は未了**である）。
...
3. **機密区分の表示名**（4 値のうち 2 値しか計画に現れない）。**環流の記録は作成済み・起票は未了。**
