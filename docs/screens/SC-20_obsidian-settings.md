...
iadrs: [IADR-0121, IADR-0124, IADR-0125, IADR-0127, IADR-0131, IADR-0134, IADR-0135, IADR-0262, IADR-0270, IADR-0338, IADR-0352, IADR-0437, IADR-0444, IADR-0446]
specs: [20260828_issue-451c_sc19-sc20-screens, 20260828_issue-451a_private-notes-bff, 20260902_issue-1098_obsidian-plugin-pull-stage1, 20260903_issue-1153_obsidian-plugin-push-delete-conflict-stage2, 20260912_1441-1442_private-note-contract-gaps, 20260912_1445-1446_share-targets-and-sync-history]
issues: [#451, #1098, #1153, #1441, #1442, #1446, planning#614, planning#618]
-->
...
| 19 | 同期履歴 | 競合の区画の**下**に置く（失敗理由の文言が「上の『同期の競合』から解決してください」と上を指すため）。列は 実行日時 / 端末 / 方向（送信・受信）/ 内訳 / 結果 / 失敗理由。0 件は「同期の記録はまだありません」 |
...
| 同期履歴 / エラー表示 | する | 供給元は**既存の同期監査ログ**であり専用の履歴ストアを持たない（計画側の裁定）。表示は直近 50 件・保持は 3 年で、**どちらも画面が決めた値ではない**。失敗も並び、理由は「次に何をすればよいか」の文言へ写す。🔴 **タイトル・パスの列を持たない**ことを単体テストとブラウザ E2E が陽性対照（端末の列は在る）つきで固定する |
