...
iadrs: [IADR-0121, IADR-0124, IADR-0125, IADR-0127, IADR-0134, IADR-0135, IADR-0262, IADR-0270, IADR-0338]
specs: [20260828_issue-451c_sc19-sc20-screens, 20260828_issue-451a_private-notes-bff, 20260902_issue-1098_obsidian-plugin-pull-stage1]
issues: [#451, #1098]
-->
...
> いずれも呼ぶ口が存在しない。**プラグイン本体は 2026-09-02 に第 1 段（取り込みのみ）が入った**
> （[機能仕様書 §Obsidian プラグイン](../functional/FR-20_obsidian-sync.md)。同期対象フォルダは
> プラグイン側の設定で、本画面には口が無いまま）。
> **「双方向の同期が動く」とは読まないこと。** 見送りの一覧は §計画（画面設計）との対応 にある。
...
| 競合の一覧と解決 UI（2 ペイン差分・3 択） | **しない** | 🔴 **競合を読む口も解決する口も公開 API に無い。** 自動解決を既定にしない方針は守られている（そもそも解決の口が無い） |
