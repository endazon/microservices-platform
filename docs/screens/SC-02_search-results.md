...
specs: [20260804_issue-502_sc01-03-search-flow, 20260809_issue-642_qdrant-tag-restoration]
issues: [#446, #490, #502, #519, #531, #532, #534, #536, #538, #553, #642, planning#197]
-->
...
| 11 | **共通シェル**: パンくず（413）・ブランド／アバター（412）・左ナビ（414） | — | **対象外（本画面の作業ではない）。** パンくず（**#446 で実装した**。本画面は親画面の段を持つ）・ブランド・アバター・左ナビは `foundation/ui/Layout` が持つ |
