...
iadrs: [IADR-0197, IADR-0261, IADR-0332, IADR-0344, IADR-0347, IADR-0369, IADR-0403]
specs: [20260823_issue-438_keycloak-theme-and-smtp, 20260828_issue-439_sc16-account-settings, 20260831_issue-1102_keycloak-smtp-externalsecret-wiring, 20260902_issue-1144_dev-mail-capture-mta, 20260902_issue-1143_reset-existence-concealment, 20260906_issue-1245_nearby-mta-relay]
...
| # | 状態（変更後） | 実在 | 非実在 | 判定 |
| --- | --- | --- | --- | --- |
| A | 中継稼働・上流稼働・申請が開いている | 200 | 200 | **一致**（所要時間の差は未実測。閾値は計画が実測後に定める） |
...
現状の防ぎ方は[運用 Runbook](../operations/keycloak-smtp-relay-setup-runbook.md) の**人手の手順**だけである。
**「窓は無い」と読まないこと。**
