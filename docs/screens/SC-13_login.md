...
iadrs: [IADR-0197, IADR-0251, IADR-0261, IADR-0273, IADR-0347, IADR-0427, IADR-0429, IADR-0432, IADR-0461, IADR-0468]
...
- **判定するのはステータス・リダイレクト先・応答本文の 3 面**で、
  ...
  **［2026-09-11 更新］判定条件は定まったが、本経路は明示的にその対象外である**
  （条件が反復を前提とし、本経路は失敗回数のしきい値で標本を増やせないため。§未決事項）。
...
- **所要時間に有意な差があった場合にどう扱うか**は計画側の裁定事項である。
  **［2026-09-11 更新］判定条件は定まったが、本経路は明示的にその対象外である。**
