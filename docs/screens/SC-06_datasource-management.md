...
issues: [#446, #490, #502, #506, #519, #534, #537, #538, #628, #754, #767, #796, planning#198, planning#200, planning#299, planning#372]
-->
...
| 13 | **共通シェル**: パンくず（413）・ブランド／アバター（412）・左ナビ（414） | — | **対象外（本画面の作業ではない）。** パンくず（**#446 で実装した**。グループ段「管理」をバッジで描く）も他も `foundation/ui/Layout` が持つ |
