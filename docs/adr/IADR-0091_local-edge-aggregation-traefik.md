...
> **［2026-08-16 追記 / #779］本決定 3 の証明書に関する部分は [[IADR-0204]] が Supersede した。**
...
- 80/443 はホスト権限・既存サービスとの衝突・443 自己署名の制約あり（README 明記。**自己署名の制約は
  [[IADR-0204]] が解いた** —— cert-manager の CA 発行証明書へ移行済み）。占有時は LOCALEDGE を使わず
