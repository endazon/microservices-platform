...
7. **ADR-0035（GraphRAG 検索戦略）は未起案**であり、RAG へのグラフ組み込み部分には着手しない
   ...
   - > **［2026-08-07 追記・事実の更新。本規約 7 の保留は解けた / #586］`ADR-0035` は 2026-08-07 に
     ...
     > **［2026-08-07 追記 / #599］この記述は同日中に古くなった。** **［2026-08-07 / #599］FR-19 / FR-20 の保留は範囲基準へ変わった**（[[IADR-0142]] 決定 1・2。**範囲の正は計画 `ADR-0037` の「着手可否の注記」**であり、ここには転記しない —— 転記すると計画側が動いたとき一斉に腐る）。
