...
- この決定は ADR-0011 の「Wiki.js を採用し閲覧実体を委譲する」部分を**覆す**ため、計画 ADR-0011 の `Superseded` 化と後継 ADR の起票を `/plan-feedback`（[feedback 記録](../../feedback/20260703_wiki-selfhosted-supersedes-adr-0011.md)）で提案する。計画確定は `/triage-feedback` と人間が行う。
...
- フォローアップ:
  - 計画 ADR-0011 の `Superseded` 化と後継 ADR 起票を feedback で提案（[記録](../../feedback/20260703_wiki-selfhosted-supersedes-adr-0011.md)）。
