...
- 関連する計画書 ID: 計画
  ...
  [`ADR-0030`](../../planning/projects/microservices-platform/07_adr/ADR-0030_backend-application-libraries.md)（ライブラリ標準。**選定基準 2 は「標準機能優先」である** ——
...
>   [[IADR-0117]] 決定 1〜4 も生きている。置き分けは **サービス単位 = 自サービスに閉じた共通基底 /
...
>
> - **実測**: 計画 [`ADR-0030`](../../planning/projects/microservices-platform/07_adr/ADR-0030_backend-application-libraries.md)
...
>   [[IADR-0117]] フォローアップ 2 も同時に決着している（**未達ではなく、提案が却下されての決着**）。
