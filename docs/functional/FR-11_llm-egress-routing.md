...
- 既定設定（`appsettings.json`, ADR-0010 `Accepted` / ADR-0025 / IADR-0022 / IADR-0101）: 既定 `claude-opus-5`、定型 `rag-answer→claude-sonnet-4-6` / `diagram-coding→claude-haiku-4-5`、最難関 `analysis→claude-fable-5`（ZDR 非要件区分のみ）、`default→claude-opus-5`。
