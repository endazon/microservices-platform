...
iadrs: [IADR-0007, IADR-0022, IADR-0037, IADR-0101, IADR-0102, IADR-0104, IADR-0106, IADR-0109, IADR-0110, IADR-0111, IADR-0112, IADR-0113, IADR-0114, IADR-0225, IADR-0335]
...
- 実装ADR: `../../.ai-context/adr/IADR-0225_llm-purpose-fallback-chain-and-429-boundary.md`（用途別フォールバック順序・429 の境界・発火の可観測化）、`../../.ai-context/adr/IADR-0007_llm-egress-routing-config-driven.md`（config 駆動ルーティング）、
  ...
  `../../.ai-context/adr/IADR-0335_trade-decision-screening-purpose-registration.md`（二段判断の層別用途登録・報告書 3 種のフォールバック鎖登録）
