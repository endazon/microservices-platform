...
3. 時間範囲を**前月 1 か月**に合わせる。
4. 次の 4 点を見る。**絶対額のしきい値は使わない**（決定 41）。

   | 見るもの | パネル | 注意して見る点 |
   | --- | --- | --- |
   | **前月比の増減** | 前月比（用途別） | **1.0 を大きく超える用途**が無いか。目安として **1.5 倍**を超えたら §増加を認めたとき へ |
   | **月内累計の推移** | 月内累計（用途別 / モデル別） | 月の後半で**傾きが急に立っていない**か（月末に集中している用途は翌月に跳ねやすい） |
   | **モデル構成の変化** | 月内累計（モデル別） | **上位モデルの比率が上がっていないか**。回数が同じでも費用は増える |
