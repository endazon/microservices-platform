...
// SC-19, SC-20, SC-22, FR-19/FR-20: 取り返しのつかない操作の手前に置く確認ダイアログ。
//
// ■ ここに置く理由（作業仕様書 §判断 3）
//   計画が確認ダイアログを要求するのは SC-19 / SC-20 の 2 画面である（［2026-09-26 追記 / #1523］SC-22 も
//   ADR-0110 決定 3 で「書き込みの確認＝消費側の再起動の確認」を置くようになり、3 画面になった）。2 画面が同じ部品を要るので、
