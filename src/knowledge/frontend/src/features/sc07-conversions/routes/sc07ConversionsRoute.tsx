...
// 運用者の閲覧まで奪うことになる。
// **［2026-08-10 追記 / #553］「閲覧ロールの差異は planning#198 提案 8 で裁定待ち」は失効した** ——
// 裁定 Q19（2026-08-05）が「閲覧は管理者・運用者／破壊的操作は管理者限定」と定め、計画側が
// 実装へ合わせて改訂された（01_screens.md:124 / :314）。**この分離は追認済みである。**
//
...
const ConversionJobsPage = lazyRouteComponent(
  () => import('../components/ConversionJobsPage'),
  'ConversionJobsPage',
);
