...
// （ADR-0061 決定 1・2 / [[IADR-0396]] 決定 4。[[IADR-0270]] 決定 5「発行しない」の後継）。
...
public static class PrivateNoteEndpoints
{
    ...
    // （[[IADR-0283]] 決定 4 / ADR-0061 決定 3 / [[IADR-0396]] 決定 1）——
    ...
    // FR-19, SC-19 / IADR-0405 決定 1・2: 列の詰め替えは `PrivateNoteMapper` の生成マッパが行う。
    //
