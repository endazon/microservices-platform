...
namespace DocumentService.Tests.Infrastructure.Persistence;
...
public class JsonbValueComparerContractTests
{
    ...
    {
        using var ctx = new DocumentDbContext(
        ...
        comparers.Should().NotBeEmpty("Document/DocumentVersion の Attributes(jsonb) に ValueComparer が設定されているはず");
