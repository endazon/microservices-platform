...
// FR-06, UC-03, NFR-09, NFR-16, ADR-0029, ADR-0075, [[IADR-0379]], [[IADR-0402]] (#1255):
// 文書読み取りの gRPC 面のための器。**AuthorizationService の同名の器と同型**である。
//
...
public sealed class GrpcKestrelFactory : WebApplicationFactory<Program>
{
    ...
    private readonly string _dbName = $"DocumentGrpc_{Guid.NewGuid()}";
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            services.AddSingleton<IObjectStorageClient>(new RecordingObjectStorageClient());
