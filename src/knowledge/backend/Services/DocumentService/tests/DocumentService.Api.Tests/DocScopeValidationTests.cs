    ...
    : IClassFixture<TestWebApplicationFactory>
{
    ...
    {
        DocumentService.Api.Foundation.Ports.PrivateNoteNotificationKinds.PrivateNotePurgeWeekly
            .Should().Be("private-note-purge-weekly");
        DocumentService.Api.Foundation.Ports.PrivateNoteNotificationKinds.PrivateNotePurgeImminent
            .Should().Be("private-note-purge-imminent");
        DocumentService.Api.Foundation.Ports.PrivateNoteNotificationKinds.PrivateNotePurgeDone
            .Should().Be("private-note-purge-done");
        DocumentService.Api.Foundation.Ports.PrivateNoteNotificationKinds.StorageQuotaWarning
            .Should().Be("storage-quota-warning");
        DocumentService.Api.Foundation.Ports.PrivateNoteNotificationKinds.SyncTokenExpiry
