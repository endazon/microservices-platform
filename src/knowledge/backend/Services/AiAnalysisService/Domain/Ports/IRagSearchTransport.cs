...
// [[IADR-0379]], [[IADR-0400]], [[IADR-0415]], [[IADR-0416]], [[IADR-0425]] (#1255):
...
//
// 🔴 **失敗は例外にせず空へ縮退する**（[[IADR-0425]] 決定 4）。REST の「非 2xx」「不達」と
...
/// <summary>
/// FR-05, NFR-09, 計画 ADR-0086 決定 1, [[IADR-0415]], [[IADR-0416]], [[IADR-0425]] 決定 1:
/// 1 回の RAG 検索の要求。
///
