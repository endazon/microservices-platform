...
// UC-07 基本フロー 1「**検索する**」, FR-13, FR-05, FR-19, ADR-0011, IADR-0009, IADR-0335:
...
public class WikiSearchAbacTests(WikiSearchTestFactory factory) : IClassFixture<WikiSearchTestFactory>
{
    ...
    // IADR-0335: 台帳に足場を持たないページ（Wiki.js 上で人手で作られた等）は ABAC 判定できないので落ちる。
    ...
    // IADR-0335: **Wiki.js の関連度順を保つ**（台帳の並びで上書きしない）。
    [Fact]
    ...
    // 🔴 IADR-0335 / IADR-0256: **後段の故障を 200 ＋ 空で隠さない。**
