...
// FR-17, UC-10, ADR-0033 未決事項, IADR-0241 決定 11: グラフの読み取りポート。
//
...
// 展開することが型として書けない（IADR-0241 決定 2）。署名を GraphDocument や Guid へ
// 緩めてはならない。
public interface IGraphStore
{
    ...
    // 利用者から見て「見えたり見えなかったり」する（ADR-0034 決定 4 / IADR-0241 決定 4）。
