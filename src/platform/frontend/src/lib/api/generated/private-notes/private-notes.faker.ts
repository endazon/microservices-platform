...
export const getBffSyncConflictGetResponseMock = (overrideResponse: Partial<Extract<SyncConflictDetailDto, object>> = {}): SyncConflictDetailDto => ({id: faker.string.uuid(), noteId: faker.string.uuid(), title: faker.string.alpha({length: {min: 10, max: 20}}), vaultPath: faker.string.alpha({length: {min: 10, max: 20}}), detectedAt: faker.date.past().toISOString().slice(0, 19) + 'Z', deviceId: faker.string.uuid(), deviceName: faker.string.alpha({length: {min: 10, max: 20}}), localBaseVersion: faker.number.int(), serverVersion: faker.number.int(), localContent: faker.string.alpha({length: {min: 10, max: 20}}), serverContent: faker.string.alpha({length: {min: 10, max: 20}}), ...overrideResponse})

export const getBffSyncConflictResolveResponseMock = (overrideResponse: Partial<Extract<ResolveSyncConflictResponse, object>> = {}): ResolveSyncConflictResponse => ({conflictId: faker.string.uuid(), noteId: faker.string.uuid(), resolution: faker.string.alpha({length: {min: 10, max: 20}}), noteVersion: faker.number.int(), createdNoteId: faker.helpers.arrayElement([faker.string.uuid(), null]), ...overrideResponse})
