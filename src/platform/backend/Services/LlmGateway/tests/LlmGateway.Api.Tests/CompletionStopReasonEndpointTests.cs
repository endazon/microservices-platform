    ...
    : IClassFixture<TestWebApplicationFactory>
{
    ...
    public async Task PostComplete_WhenEgressDenied_HasNoStopReason()
    {
        var client = factory.WithWebHostBuilder(b =>
            b.ConfigureServices(s =>
                s.Configure<Foundation.Routing.LlmRoutingOptions>(o =>
                {
                    o.AllowUnapprovedTierC = false;
                    o.Endpoints =
                    [
                        new Foundation.Routing.LlmEndpointOptions
                        {
                            Name = "standard-external", Tier = Foundation.Routing.ProtectionTier.C,
