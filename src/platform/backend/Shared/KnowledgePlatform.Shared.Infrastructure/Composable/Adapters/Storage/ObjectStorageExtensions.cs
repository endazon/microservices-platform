...
namespace KnowledgePlatform.Shared.Infrastructure.Composable.Adapters.Storage;
...
public static class ObjectStorageExtensions
{
    ...
    public static IServiceCollection AddKnowledgePlatformObjectStorage(
    ...
    public static IServiceCollection AddKnowledgePlatformObjectStorageBootstrap(
