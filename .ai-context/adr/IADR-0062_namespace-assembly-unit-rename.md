...
- 関連 ADR: [IADR-0027](./IADR-0027_composability-folder-structure.md)（名前空間＝フォルダ階層一致）／[IADR-0056](./IADR-0056_repo-unit-structure-platform-knowledge.md)（ユニット第一構成）／[IADR-0059](./IADR-0059_contract-layering-unit-contracts.md)（契約階層化。本 IADR で URN 固定を撤廃）
...
**方針: 後方互換は持たせない（旧名・旧 URN は削除）**。[IADR-0059](./IADR-0059_contract-layering-unit-contracts.md) は当初 6 イベントの URN を
...
- `src/README.md` を新名称へ更新。[IADR-0059](./IADR-0059_contract-layering-unit-contracts.md) の URN 固定記述を撤廃へ更新。
