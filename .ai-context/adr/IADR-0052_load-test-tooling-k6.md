...
- **SLO のコード表現＋ゲート化**: threshold 未達で非ゼロ終了するため、ステージング整備（[IADR-0049](./IADR-0049_composability-standards-phased-adoption.md) / #207）後に
...
- ステージング整備（#207 / [IADR-0049](./IADR-0049_composability-standards-phased-adoption.md)）で nightly ゲート化を検討。
