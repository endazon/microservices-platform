...
## ［2026-09-26 追記 / #1541］決定 5 の判定式（2 段を含む）は IADR-0470 が置き換えた —— 順位和検定（両側・有意水準 1%）

計画 ADR-0113（planning#659 の裁定）が ADR-0094 決定 1 の判定式と ADR-0103 決定 1（段 1）を部分改定し、判定を**順位和検定**へ改めた。
**決定 5 の判定式（比が自己対照を超えない）と 2026-09-25 追記の 2 段の判定・刻みの導出は `IADR-0470` が置き換える**（暖機を除く 2 反復を
...
- Superseded by: なし（［2026-09-25 / #1470］決定 5 の判定式は計画 ADR-0103 に従い 2 段にした。
  ...
  ［2026-09-26 / #1541］決定 5 の判定式（2 段を含む）は `IADR-0470` が順位和検定へ置き換えた。いずれも上の追記）
