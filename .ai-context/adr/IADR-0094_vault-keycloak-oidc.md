...
- 関連 ADR: ADR-0006。Vault dev opt-in は [IADR-0077](./IADR-0077_local-observability-vault-gitops-overlays.md)、OIDC 連携先例 [IADR-0090](./IADR-0090_grafana-keycloak-oidc-generic-oauth.md)（Grafana）、エッジ集約 [IADR-0091](./IADR-0091_local-edge-aggregation-traefik.md)。
