...
- 関連 ADR: [IADR-0025](./IADR-0025_embedding-provider-routing-and-model-collections.md)（埋め込みプロバイダのルーティング／機密区分別コレクション／fail-closed の決定＝本 ADR の前提）
...
検出された。これは [IADR-0025](./IADR-0025_embedding-provider-routing-and-model-collections.md) / ADR-0017 の **fail-closed 設計として正しい**挙動だが、その前提であるセルフホスト
