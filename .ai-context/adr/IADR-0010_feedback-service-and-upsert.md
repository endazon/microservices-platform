...
- **一覧の認可**: `GET /feedback` は自由記述 `Comment` と `UserId`（個人特定情報）を返すため、`AdminOnly`
  ...
  - > **［2026-08-07 追記・事実の更新 / #586］この「認可を課さない」は計画と食い違う。**
    ...
    > **［2026-08-10 是正 / #521・[IADR-0158](./IADR-0158_feedback-endpoint-authz.md)］実装が計画へ揃った。** `/feedback/stats` へ
    ...
    > 同型の記述: [機能仕様書 FR-08](../../docs/functional/FR-08_answer-feedback.md)・
    > [通信仕様書](../../docs/api/BFF_bff-surface.md) §未決事項 3・[IADR-0158](./IADR-0158_feedback-endpoint-authz.md)。
