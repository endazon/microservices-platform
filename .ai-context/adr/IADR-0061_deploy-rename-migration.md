...
- 関連する計画書 ID: FR-14／ADR-0007（ArgoCD+Helm）／ADR-0008（k3s）／[IADR-0056](./IADR-0056_repo-unit-structure-platform-knowledge.md)（ユニット第一構成）
...
「主=プラットフォーム基盤」の位置づけ（#209 / [IADR-0056](./IADR-0056_repo-unit-structure-platform-knowledge.md)）と不整合のまま `knowledge-platform` を名乗っていた。
