...
- 関連 ADR: [IADR-0063](./IADR-0063_bff-unit-endpoint-composition.md)（BFF 合成点・例外3 の規範）／[IADR-0056](./IADR-0056_repo-unit-structure-platform-knowledge.md)（ユニット構成）／
  [IADR-0057](./IADR-0057_unit-dependency-machine-check.md)（一方向依存）／[IADR-0070](./IADR-0070_ast-frontend-integration.md)（assumptions・決定4=interim）／
  [IADR-0071](./IADR-0071_ast-risk-controls-bff-integration.md)（risk-controls・決定4）／[IADR-0072](./IADR-0072_ast-monitor-bff-integration.md)（monitor・決定4）／
