...
- 関連 ADR: [IADR-0078](./IADR-0078_frontend-k8s-serving.md)（#313・frontend の k8s 配信＝stale が顕在化した箇所）／
  [IADR-0081](./IADR-0081_frontend-base-registry-mirror.md)（#325・ビルド base の非 docker.io 化＝`BASE_REGISTRY`）。
