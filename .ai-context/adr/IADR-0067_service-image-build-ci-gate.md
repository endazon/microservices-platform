...
- 関連 ADR: [IADR-0063](./IADR-0063_bff-unit-endpoint-composition.md)（BFF のユニット別エンドポイント合成点）／[IADR-0066](./IADR-0066_local-k8s-dev-environment.md)（ローカル k8s dev 環境。発見元）
...
- **BFF**: [IADR-0063](./IADR-0063_bff-unit-endpoint-composition.md) の合成点として `knowledge/backend/Bff/Knowledge.Bff.Endpoints` を無条件参照するが、
...
- compose は既に**ビルドコンテキストと dockerfile の単一情報源**であり、対象リストを CI に
  ...
  [IADR-0060](./IADR-0060_submodule-unit-operations.md) 系の「ユニット追加時に CI を編集しない」方針の踏襲）。
