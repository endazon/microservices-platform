---
title: IADR-0249 BFF セッション（Token Handler）の内部設計 — CSRF は SameSite+ヘッダ、コールバックは query、失効は TicketStore の削除
type: impl-adr
status: Accepted
related_ids: [NFR, SC-13, SC-14, SC-15, SC-16, ADR-0026, ADR-0031, ADR-0032, IADR-0033, IADR-0121, IADR-0248]
author: claude
created: 2026-08-22
updated: 2026-08-22
plan_refs:
...
# IADR-0249: BFF セッション（Token Handler）の内部設計
