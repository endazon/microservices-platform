...
- 状態: **Superseded**（by [IADR-0461](./IADR-0461_object-storage-seaweedfs-deployment.md)・2026-09-25）
- 日付: 2026-07-21
- 決定者: claude（実装）
...
> **［2026-09-25 追記 / #1499］本 IADR は [IADR-0461](./IADR-0461_object-storage-seaweedfs-deployment.md) 決定 5 により Superseded である。**
...
- Superseded by: [IADR-0461](./IADR-0461_object-storage-seaweedfs-deployment.md)（2026-09-25・#1499）
