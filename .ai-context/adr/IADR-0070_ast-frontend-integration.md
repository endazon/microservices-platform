...
- 関連 ADR: [IADR-0056](./IADR-0056_repo-unit-structure-platform-knowledge.md)（ユニット構成）／[IADR-0057](./IADR-0057_unit-dependency-machine-check.md)（一方向依存）／[IADR-0063](./IADR-0063_bff-unit-endpoint-composition.md)（BFF 合成点・例外3）／
  [IADR-0068](./IADR-0068_image-mapping-drift-check.md)（image-mapping ドリフト検査）／ AST/IADR-0080（AST フロント第1スライス）
...
> **［2026-08-04 追記］決定 1 の「厳密同形」は [IADR-0124](./IADR-0124_tanstack-router-unit-composition.md)（#490）で部分改定された。**
> 計画 ADR-0031（計画リポ） が
...
> **この非同形は本リポジトリから AST を変更できないこと（[IADR-0120](./IADR-0120_excluded-units-from-gitmodules.md)）の写像であり、意図的である。**
...
> **更新（2026-07-19・#286 / [IADR-0073](./IADR-0073_ast-unit-owned-bff-migration.md)）**: 本 interim は #286 で解消済み。`AssumptionsBffEndpoints` は
