...
- 関連 ADR: ADR-0018（契約・イベント疎結合）／[IADR-0027](./IADR-0027_composability-folder-structure.md)（Foundation/Composable 依存方向）／[IADR-0056](./IADR-0056_repo-unit-structure-platform-knowledge.md)（ユニット第一構成）
