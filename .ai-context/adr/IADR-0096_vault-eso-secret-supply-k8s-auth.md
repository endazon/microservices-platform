...
- 関連 ADR: ADR-0006 / ADR-0010（llm-provider-credentials の消費）。Vault dev/ESO opt-in は [IADR-0077](./IADR-0077_local-observability-vault-gitops-overlays.md)、Vault の
  runtime bootstrap 先例は [IADR-0094](./IADR-0094_vault-keycloak-oidc.md)。
