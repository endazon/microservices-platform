...
- 計画側は本裁定を ADR-0101（ADR-0098 の補完。起案中）として記録する。 **［2026-09-13 追記 / #1451］planning#627 でマージ済み（planning `165e6e2`）。ADR-0101 決定 1〜4（所有者にだけ返す／空集合を返さない／適用面は利用者へ返る応答／ADR-0098 フォローアップ 5 の解消）は本 IADR の決定 1〜3 と一致する。**
