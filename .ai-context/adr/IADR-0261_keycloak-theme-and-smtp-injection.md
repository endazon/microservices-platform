...
> **［2026-09-06 追記 / #1245 / IADR-0403］決定 2 の反映先が変わった（秘匿値の扱いは変えない）。**
...
> realm 側の値はすべて非秘匿のクラスタ内 Service 名であり、実値は 1 つも混ざらない。詳細は [IADR-0403](./IADR-0403_nearby-mta-relay-and-realm-ownership.md)。
