...
- 関連 ADR: [IADR-0084](./IADR-0084_headlamp-oidc-apiserver-flags.md)（#328。`k3d cluster create` の apiserver OIDC フラグ＝本テストの主要検証対象）／
  [IADR-0066](./IADR-0066_local-k8s-dev-environment.md)（経路B＝k3d dev 環境・`k8s-local-up.sh` の全体構造）。
...
> **［2026-07-26 追記］`HEADLAMP_OIDC_APISERVER` ゲートは [IADR-0105](./IADR-0105_remove-apiserver-oidc-flag-wiring.md)（#399）で除去された。** 本 ADR のテスト方式
