...
7. **拒否報告が原因を隠す（planning#158 / planning#160）**: 6 の対処を入れた PR #437 のレビューで
   ...
   （feedback/20260802_review-allowlist-diff-and-denial-labeling.md（環流記録。計画リポ `projects/microservices-platform/10_feedback/20260802_review-allowlist-diff-and-denial-labeling.md` へ移設））。
