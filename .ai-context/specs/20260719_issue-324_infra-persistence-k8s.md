...
- 関連 ADR: ADR-0004（認証＝Keycloak）。方式判断は [IADR-0082](../adr/IADR-0082_local-k8s-infra-persistence.md)。既存 [IADR-0066](../adr/IADR-0066_local-k8s-dev-environment.md)（経路B の
  `emptyDir` 割り切り＝本 issue が見直す対象）／[IADR-0079](../adr/IADR-0079_infra-persistence-compose.md)（compose 側の永続化・別レイヤの先例）。
