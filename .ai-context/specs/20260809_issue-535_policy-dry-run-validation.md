...
related_specs:
  - "../../docs/functional/FR-09_abac-attribute-policy-management.md"
...
| 3 | `Platform.Bff/.../Endpoints/AuthzBffEndpoints.cs` | `/bff/admin/authz/policies/validate` のパススルー（[IADR-0040](../adr/IADR-0040_admin-abac-bff-passthrough-and-admin-only.md) 決定 2。AdminOnly） |
