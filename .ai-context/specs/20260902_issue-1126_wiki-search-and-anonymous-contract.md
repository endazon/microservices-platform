...
- 本作業の実装 ADR: **[[IADR-0335]]**（`develop` の最大値 +1。並行 PR と衝突したらマージ直前に改番する）
...
- 追加 `.ai-context/adr/IADR-0335_wiki-search-delegated-with-gateway-abac.md` ＋ 索引
...
#1148（planning submodule 残存記述）が同番を取ったため **`IADR-0335` へ改番**した（0332・0333 も
