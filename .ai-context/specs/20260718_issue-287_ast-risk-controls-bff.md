...
- 実装判断: [IADR-0056](../adr/IADR-0056_repo-unit-structure-platform-knowledge.md)／[IADR-0057](../adr/IADR-0057_unit-dependency-machine-check.md)（一方向依存）／[IADR-0063](../adr/IADR-0063_bff-unit-endpoint-composition.md)（BFF 合成点・例外3）／
  [IADR-0068](../adr/IADR-0068_image-mapping-drift-check.md)（image-mapping ドリフト検査）／[IADR-0070](../adr/IADR-0070_ast-frontend-integration.md)（先行・SC-01）／
  **[IADR-0071](../adr/IADR-0071_ast-risk-controls-bff-integration.md)（本スライスの設計判断）**
...
の BFF 登録＋RiskManagementService の deploy 登録）を完了させる。合成の形・pass-through 方針は [IADR-0070](../adr/IADR-0070_ast-frontend-integration.md) を踏襲する。
...
- [ ] 設計判断が [IADR-0071](../adr/IADR-0071_ast-risk-controls-bff-integration.md) に記録され、live 依存が #284 へ分離されている。
