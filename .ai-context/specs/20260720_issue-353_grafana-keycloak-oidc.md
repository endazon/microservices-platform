...
- ADR: ADR-0006（CI/CD・運用基盤）。経路B の可観測性 opt-in オーバーレイの統括は [IADR-0077](../adr/IADR-0077_local-observability-vault-gitops-overlays.md)、
  経路B k8s dev 環境の統括は [IADR-0066](../adr/IADR-0066_local-k8s-dev-environment.md)、opt-in ゲート横断 smoke test は [IADR-0087](../adr/IADR-0087_k8s-local-up-optin-smoke-test.md)。
- 決定: 本作業の設計判断は [IADR-0090](../adr/IADR-0090_grafana-keycloak-oidc-generic-oauth.md)（Grafana generic OAuth・匿名廃止・fail-safe）。
