...
- 決定: [IADR-0107](../adr/IADR-0107_ast-owned-service-single-deployment.md)（本作業で新規）。前提は [IADR-0066](../adr/IADR-0066_local-k8s-dev-environment.md)（MSP+AST 連結ローカル k8s dev 環境）・
  [IADR-0071](../adr/IADR-0071_ast-risk-controls-bff-integration.md)（AST/SC-02・AST/SC-03 のリスク統制 BFF 連携）・[IADR-0072](../adr/IADR-0072_ast-monitor-bff-integration.md)（AST/SC-02 watchlist の BFF 連携）・
...
経路B の構成に反映する。詳細な判断根拠と代替案の棄却理由は [IADR-0107](../adr/IADR-0107_ast-owned-service-single-deployment.md) を参照。
