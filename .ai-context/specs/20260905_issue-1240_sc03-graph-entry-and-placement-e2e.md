...
type: spec
status: done
related_ids: [FR-17, FR-18, SC-03, SC-04, SC-18, UC-01, UC-02, UC-07, UC-10, ADR-0033, ADR-0034, ADR-0035, ADR-0066, IADR-0119, IADR-0124, IADR-0300, IADR-0365, IADR-0386]
author: Claude
created: 2026-09-05
updated: 2026-09-05
plan_refs:
...
- 実装 ADR: `IADR-0119`（着手保留。2026-08-07 に `FR-17` / `FR-18` について解除済み）/
  `IADR-0300`（承認欄）/ `IADR-0124`（ルート）/ 本作業の `IADR-0386`
...
こちらが古くなっても壊れ方は「別の深さで開く」に留まる（論拠の正本は `IADR-0386` 決定 1）。
