...
- **検査そのものは変えない。** [`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) の
...
| [`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) | Y-3: ゲート一覧の「ライブラリ標準」行へ測定範囲 |
