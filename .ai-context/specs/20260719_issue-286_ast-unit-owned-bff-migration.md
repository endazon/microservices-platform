...
- 実装判断: [IADR-0063](../adr/IADR-0063_bff-unit-endpoint-composition.md)（BFF 合成点・例外3 の規範）／[IADR-0056](../adr/IADR-0056_repo-unit-structure-platform-knowledge.md)／[IADR-0057](../adr/IADR-0057_unit-dependency-machine-check.md)（一方向依存）／
  [IADR-0070](../adr/IADR-0070_ast-frontend-integration.md)（assumptions・決定4=interim）／[IADR-0071](../adr/IADR-0071_ast-risk-controls-bff-integration.md)（risk-controls・決定4）／
  [IADR-0072](../adr/IADR-0072_ast-monitor-bff-integration.md)（monitor・決定4）／**[IADR-0073](../adr/IADR-0073_ast-unit-owned-bff-migration.md)（本移行の設計判断）**
