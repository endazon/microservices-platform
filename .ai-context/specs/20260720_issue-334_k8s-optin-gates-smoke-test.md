...
- 関連 ADR: 方式判断は [IADR-0087](../adr/IADR-0087_k8s-local-up-optin-smoke-test.md)（stub-on-PATH・スクリプト無改変）。検証対象の分岐は
  [IADR-0084](../adr/IADR-0084_headlamp-oidc-apiserver-flags.md)（apiserver OIDC フラグ）・[IADR-0066](../adr/IADR-0066_local-k8s-dev-environment.md)（経路B＝k3d dev 環境）・IADR-0077/0080/0082 等。
...
方式判断は [IADR-0087](../adr/IADR-0087_k8s-local-up-optin-smoke-test.md) に記録。要点:
