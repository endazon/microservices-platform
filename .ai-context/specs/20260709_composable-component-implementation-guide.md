...
- [deploy/helm/microservices-platform/files/README.md](../../deploy/helm/microservices-platform/files/README.md):
  段追加の 3 手順（構成変更運用の一部として記載）
- [固定/可変区分表](../../docs/tech/composability-classification.md): 既存コードの棚卸し（現状の写像であり手順書ではない）
