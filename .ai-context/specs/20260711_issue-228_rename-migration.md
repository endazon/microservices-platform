...
- 実装判断: [IADR-0061](../adr/IADR-0061_deploy-rename-migration.md)（Blue/Green 移行・新名称パラメータ化・実行繰延）
- Issue: #228（フォローアップ 2）
...
- 対象外（[IADR-0061](../adr/IADR-0061_deploy-rename-migration.md) フォローアップ・#228 に残す。実環境が必要）:
...
- 方式（Blue/Green・realm export/import・ArgoCD 新 Application・イメージ再タグ）は [IADR-0061](../adr/IADR-0061_deploy-rename-migration.md) に記録。
