...
- 実装判断: [IADR-0056](../adr/IADR-0056_repo-unit-structure-platform-knowledge.md)（ユニット構成 platform/knowledge）／[IADR-0057](../adr/IADR-0057_unit-dependency-machine-check.md)（一方向依存）／
  [IADR-0063](../adr/IADR-0063_bff-unit-endpoint-composition.md)（BFF 合成点・例外3）／[IADR-0068](../adr/IADR-0068_image-mapping-drift-check.md)（image-mapping ドリフト検査）／
  **[IADR-0070](../adr/IADR-0070_ast-frontend-integration.md)（本統合の設計判断・AST 共有 Dockerfile を context/args 対応で載せる）**
- Issue: MSP #283（本 issue）／ AST#106（T2）
- 上流: PR AST#185（AST フロント第1スライス・設定画面 AST/SC-01・[IADR-0080](../adr/IADR-0080_headlamp-k8s-management-ui.md)）
