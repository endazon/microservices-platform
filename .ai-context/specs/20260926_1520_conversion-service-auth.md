...
type: spec
status: in-progress
related_ids: [NFR-09, NFR-16, FR-12, UC-06, SC-07, ADR-0004, ADR-0029, ADR-0084, ADR-0109, IADR-0029, IADR-0042, IADR-0128, IADR-0154, IADR-0379, IADR-0403, IADR-0424, IADR-0458, IADR-0465]
author: claude
created: 2026-09-26
updated: 2026-09-26
plan_refs:
...
- **新規 IADR: IADR-0465**（`IADR-0403` 決定 5 を ConversionService について覆すため。develop の最大 0460。着手時は開いている PR #1513 の 0461 だけを見て 0462 を取ったが、push 前の引き直し〔2026-09-26〕で #1524 が 0462・#1526 が 0463・#1528 が 0464 を使っていたため 0465 へ改番した。ファイル名・自称番号・索引・本仕様書・コード内コメント・試験のコメント・docs の trace ブロックを追随させた）
...
| ヒット | 扱い |
| --- | --- |
| `IADR-0042` 決定 3 の［2026-08-05 追記］「ワーカー自身に認可を課さない点は変更していない」 | 日付つき追記で IADR-0465 を指す |
