...
- 実装判断: [IADR-0067](../adr/IADR-0067_service-image-build-ci-gate.md)（本作業で起票）／[IADR-0063](../adr/IADR-0063_bff-unit-endpoint-composition.md)（BFF 合成点）／[IADR-0066](../adr/IADR-0066_local-k8s-dev-environment.md)（ローカル k8s dev 環境＝発見元）
...
- **BFF**: [IADR-0063](../adr/IADR-0063_bff-unit-endpoint-composition.md) の合成点として `knowledge/backend/...` を参照するが、Dockerfile が
...
- `scripts/k8s-local-images.sh` の MAPPING（#266 由来の第2リスト）と compose の突き合わせ検査。
  → 本作業では扱わず、フォローアップとして [IADR-0067](../adr/IADR-0067_service-image-build-ci-gate.md) に記す。

## 設計

詳細な判断根拠は [IADR-0067](../adr/IADR-0067_service-image-build-ci-gate.md) に記す。要点のみ:
