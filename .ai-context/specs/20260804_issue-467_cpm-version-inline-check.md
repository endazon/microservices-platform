...
- 含むもの:
  ...
  5. [`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) のゲート一覧へ 1 行追加し、
...
| [`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) | ゲート一覧へ 1 行追加。「後続 issue へ切り出す項目」の本項目を取り消し線で消し込み（行は残す） |
