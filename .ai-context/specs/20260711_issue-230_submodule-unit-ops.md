...
- 実装判断: [IADR-0060](../adr/IADR-0060_submodule-unit-operations.md)
- Issue: #230（フォローアップ 4）
...
- 対象外（[IADR-0060](../adr/IADR-0060_submodule-unit-operations.md) フォローアップ・#230 に残す）:
...
- 方式（CI 自動発見 / マトリクス不採用 / 単独ビルド規約）は [IADR-0060](../adr/IADR-0060_submodule-unit-operations.md) に記録。
