...
- 実装判断: [IADR-0066](../adr/IADR-0066_local-k8s-dev-environment.md)（ローカル k8s dev 環境 = k3d・in-cluster インフラ資産・mesh/NP/HPA 無効化・イメージ import）
...
- [IADR-0066](../adr/IADR-0066_local-k8s-dev-environment.md) と本作業仕様書。
