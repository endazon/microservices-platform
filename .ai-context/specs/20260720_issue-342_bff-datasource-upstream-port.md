...
- 関連 ADR: [IADR-0039](../adr/IADR-0039_datasource-management-bff-and-role-gating.md)（datasource BFF 集約・管理系ロール限定）。方式判断は [IADR-0089](../adr/IADR-0089_bff-datasource-upstream-port.md)。
...
代替案（コード既定を 8080 に変更）は採らない。理由は [IADR-0089](../adr/IADR-0089_bff-datasource-upstream-port.md) に記録。
