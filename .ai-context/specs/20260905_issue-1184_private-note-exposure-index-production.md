...
type: spec
status: done
related_ids: [FR-19, FR-21, UC-11, SC-19, SC-20, ADR-0036, ADR-0046, ADR-0054, ADR-0057, ADR-0061, IADR-0122, IADR-0253, IADR-0270, IADR-0278, IADR-0283, IADR-0296, IADR-0358, IADR-0388, IADR-0396]
author: Claude
created: 2026-09-05
updated: 2026-09-05
plan_refs:
...
| `.ai-context/adr/IADR-0270.md`（決定 5 本体） | **本文は書き換えない。**日付つき追記で後継 `IADR-0396` を併記する |
...
- **既存の個人資料の遡及索引**（やること 6）: **実データで確認した。稼働クラスタの個人資料は 4 件、
  ...
  **したがって遡及索引の対象は 0 件であり、backfill は書かない。**（出力は `IADR-0396` §結果）
