...
- 決定: [IADR-0091](../adr/IADR-0091_local-edge-aggregation-traefik.md)（ローカルエッジ集約・Traefik。`*.localhost:50000` / フロント 80/443）のフォローアップ。
  個別 SSO は [IADR-0080](../adr/IADR-0080_headlamp-k8s-management-ui.md)（Headlamp OIDC）・[IADR-0033](../adr/IADR-0033_frontend-spa-foundation.md)（SPA foundation・OIDC public client + PKCE）。
