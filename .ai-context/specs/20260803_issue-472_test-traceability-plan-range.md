...
さらに [`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md)「各ドメイン issue が守ること」には
...
- 含むもの:
  ...
  4. [`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md): 「各ドメイン issue が守ること」の
...
[TEST_STRATEGY](../../docs/tests/TEST_STRATEGY.md#共通する設計原則-ratchet) が禁じる
...
- [x] 「各ドメイン issue が守ること」に仕様書作成義務が明記される
      — [`TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) の同節の **1 番**へ追加し、以降を繰り下げた。
- [x] 自己試験に逆方向検査の正例・負例
