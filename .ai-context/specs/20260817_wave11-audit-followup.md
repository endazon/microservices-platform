...
**[IADR-0211](../adr/IADR-0211_knip-scope-and-unused-ratchet.md) が `［2026-08-16 追記 / 波 7 末クロス監査］` を 2 ブロック持ち**、
**[IADR-0214](../adr/IADR-0214_gate-inputs-subset-of-workflow-paths.md)`:228` がその作法を引いている**（ほかに `［2026-08-07 追記 / クロス監査 §4・§5・A-1・G-a］` 4 件）。
...
[IADR-0091](../adr/IADR-0091_local-edge-aggregation-traefik.md) **決定 5**（`Accepted`・live・**本波で未改定**）が
...
[IADR-0094](../adr/IADR-0094_vault-keycloak-oidc.md) **決定 2** は
...
ところが `IADR-0220:185` は「Supersedes: **[IADR-0206](../adr/IADR-0206_local-edge-tls-cert-manager.md) 決定 4 の 2 命題のみ**」と書いていた。
**「のみ」が過小である。**

**対応**: Supersedes へ **[IADR-0094](../adr/IADR-0094_vault-keycloak-oidc.md) 決定 2 の「http/https 両登録」→「https のみ」** を併記し、
...
「[IADR-0091](../adr/IADR-0091_local-edge-aggregation-traefik.md) と [IADR-0206](../adr/IADR-0206_local-edge-tls-cert-manager.md) には追記を入れたのに、同型の前提崩れを持つ 4 件にだけ入れていなかった」と
...
- **[IADR-0094](../adr/IADR-0094_vault-keycloak-oidc.md) 本体** —— 是正 3 で本 ADR を `Supersedes` の相手として明記したが、
  **同 ADR 側の導線は既に足りている**（`［2026-08-17 追記 / #841］` が [IADR-0220](../adr/IADR-0220_admin-entrypoint-tls-and-http-redirect.md) を引き、
...
- **[IADR-0091](../adr/IADR-0091_local-edge-aggregation-traefik.md) 決定 5** —— `Accepted`・live で、**本波は改めない**。issuer の最小案維持を覆すのは **#780** である
- **新規 IADR**（起こさない。7 件はいずれも既存決定の**記述の射程**の問題であり、決定を 1 つも動かさない）

## 7. 検証（[IADR-0183](../adr/IADR-0183_false-green-warning-on-worktree-state.md) の順序）
