...
- 分類（[IADR-0141](../adr/IADR-0141_audit-rounds-and-population-drawing.md) 決定 4 ＝ **監査強度**の分岐）: **記録の追随のみ** → **全面 1 巡で打ち切り**
...
2. **pin 更新（記録の追随のみ）と運用仕様の改訂（規約の適用）は監査強度が違う**
   （[IADR-0141](../adr/IADR-0141_audit-rounds-and-population-drawing.md) 決定 4）。同じ PR に載せると重い方に引きずられ、pin 更新が滞る。

**#546 へ裁定の内容をコメントで残し、追跡できるようにした**（[IADR-0139](../adr/IADR-0139_domain-bundled-contract-prs.md) / #589 が問題にしている
