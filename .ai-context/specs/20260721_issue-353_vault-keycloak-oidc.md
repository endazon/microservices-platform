...
- ADR: ADR-0006（運用基盤）。Vault dev opt-in オーバーレイは [IADR-0077](../adr/IADR-0077_local-observability-vault-gitops-overlays.md)、OIDC 連携先例 [IADR-0090](../adr/IADR-0090_grafana-keycloak-oidc-generic-oauth.md)（Grafana）、
  エッジ集約 [IADR-0091](../adr/IADR-0091_local-edge-aggregation-traefik.md)、ゲート横断 smoke test [IADR-0087](../adr/IADR-0087_k8s-local-up-optin-smoke-test.md)。
- 決定: 本作業の設計判断は [IADR-0094](../adr/IADR-0094_vault-keycloak-oidc.md)（Vault OIDC auth method・fail-safe policy・runtime bootstrap）。
