...
- 実装判断: [IADR-0058](../adr/IADR-0058_doc-links-planning-submodule-ci.md)
- Issue: #232
...
- [x] 採用方式と理由が IADR または scripts/README に記録される
  - [IADR-0058](../adr/IADR-0058_doc-links-planning-submodule-ci.md) と `scripts/README.md` に記録。
...
- 方式選定（別ジョブ scheduled・トークン付き / URL 化不採用）は [IADR-0058](../adr/IADR-0058_doc-links-planning-submodule-ci.md) に記録。
