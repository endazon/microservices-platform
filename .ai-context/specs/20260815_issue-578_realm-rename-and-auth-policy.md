...
- [x] `resetPasswordAllowed = True` が Keycloak の既定値であって SC-15 の実装ではないことを仕様書に記録する（[SC-15 画面仕様書](../../docs/screens/SC-15_password-reset.md) 冒頭節）
