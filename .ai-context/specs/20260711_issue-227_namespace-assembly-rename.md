...
- 実装判断: [IADR-0062](../adr/IADR-0062_namespace-assembly-unit-rename.md)（命名体系・URN の新体系統一）
- Issue: #227（フォローアップ 1）
...
- 改名（[IADR-0062](../adr/IADR-0062_namespace-assembly-unit-rename.md) の命名体系）:
...
- 命名体系・URN の新体系統一（後方互換なし）は [IADR-0062](../adr/IADR-0062_namespace-assembly-unit-rename.md)（および [IADR-0059](../adr/IADR-0059_contract-layering-unit-contracts.md) の更新）に記録。
