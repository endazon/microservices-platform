...
| [`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) | ゲート一覧・検査対象ユニットの切り分け・合成点経由の混入（230〜266 行）・床の置き方 |
...
4. **[`src/coverage-floor.json`](../../src/coverage-floor.json) の `$comment` と
   [`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) の床関連節に IADR-0118 への参照を追加**
