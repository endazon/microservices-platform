...
- 関連 IADR: [IADR-0058](../adr/IADR-0058_doc-links-planning-submodule-ci.md)（private submodule の CI 取得）／[IADR-0060](../adr/IADR-0060_submodule-unit-operations.md)（submodule 運用・バージョン固定・
  Renovate/Dependabot 言及）／[IADR-0065](../adr/IADR-0065_public-unit-submodule-ci-fetch-no-token.md)（public ユニットの CI 取得はトークン不要・`src/*` 非再帰 init）
