...
- 関連 ADR: [IADR-0046](../adr/IADR-0046_config-version-history-source.md)（本件のデータ源決定）／[IADR-0029](../adr/IADR-0029_config-info-api-placement-and-drift-granularity.md)（構成情報 API 配置）／[IADR-0036](../adr/IADR-0036_sc11-config-viewer-visualization.md)（可視化方式）
...
## データ源・保持範囲の決定（[IADR-0046](../adr/IADR-0046_config-version-history-source.md)）
...
### ドキュメント
- [IADR-0046](../adr/IADR-0046_config-version-history-source.md) 新設、SC-11 画面仕様書 未決事項 3 を解決、SC-11 テスト仕様書に T-14〜T-18 追加、
  FR-15 機能仕様書へ `/history` を追記。

## 受け入れ基準

- [x] 履歴データ源・保持範囲の判断が IADR（[IADR-0046](../adr/IADR-0046_config-version-history-source.md)）に記録され、SC-11 未決事項 3 が解決している。
