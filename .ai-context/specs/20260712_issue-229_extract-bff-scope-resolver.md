...
- 実装判断: [IADR-0063](../adr/IADR-0063_bff-unit-endpoint-composition.md)（BFF 合成方式 A・段階実装 step3。Document/Search 移設の前提となる共通ヘルパ切り出し）
...
先に切り出す必要がある（[IADR-0063](../adr/IADR-0063_bff-unit-endpoint-composition.md) のテスト戦略・段階実装で予告済み）。本 PR は挙動不変の切り出しに閉じ、
