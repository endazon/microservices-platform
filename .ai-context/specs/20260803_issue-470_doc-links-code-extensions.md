...
- 計画側への環流: [planning#167](https://github.com/endazon/project-planning/issues/167)
  （記録: `feedback/20260803_doc-links-code-extensions.md`（環流記録。計画リポ `projects/microservices-platform/10_feedback/20260803_doc-links-code-extensions.md` へ移設））
...
実害が出た。[`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) が当時未マージだった
...
- 含むもの:
  ...
  6. 計画側への環流記録
     `feedback/20260803_doc-links-code-extensions.md`（環流記録。計画リポ `projects/microservices-platform/10_feedback/20260803_doc-links-code-extensions.md` へ移設）
...
- **分類 A の暫定デルタとして扱う**（[IADR-0115](../adr/IADR-0115_impl-handoff-kit-as-single-source.md)）:
  ...
  2. 環流記録を `feedback/20260803_doc-links-code-extensions.md`（環流記録。計画リポ `projects/microservices-platform/10_feedback/20260803_doc-links-code-extensions.md` へ移設）
     に単独で残す（既存記録へ相乗りしない）。
...
[`docs/tests/TEST_STRATEGY.md`](../../docs/tests/TEST_STRATEGY.md) の ※ 注記は「`check-doc-links.js` は `.js` を
