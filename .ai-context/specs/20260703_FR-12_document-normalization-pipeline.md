...
- `04_workflows/03_conversion-flow.md` は「LLM 一時障害は再試行」と定めるが、本実装は図コード化の
  ...
  feedback/20260703_conversion-retry-vs-image-fallback.md（環流記録。計画リポ `projects/microservices-platform/10_feedback/20260703_conversion-retry-vs-image-fallback.md` へ移設）
