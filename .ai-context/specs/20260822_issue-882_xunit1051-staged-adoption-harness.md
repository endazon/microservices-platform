...
決定そのものは [`IADR-0238`](../adr/IADR-0238_xunit1051-staged-adoption-ratchet.md) にある。
...
| `.ai-context/adr/IADR-0238_*.md` | **新規**。決定 4 件 |
| `.ai-context/adr/IADR-0231_*.md` | 日付つき追記 2 件（`<Import>` の誤り・件数の重複計上）。`updated:` を前進 |
| `.ai-context/adr/README.md` | `IADR-0238` の索引行。**あわせて `IADR-0234`/`0235` の並び順を昇順へ直した**（後述） |
| `docs/tech/tech-requirements.md` | 件数を 943 へ訂正し、許可リスト方式を明記。trace ブロックへ `IADR-0238` |
...
着手中に `.ai-context/adr/README.md` の索引が **`IADR-0238` → `IADR-0234` の順**で着地しており
