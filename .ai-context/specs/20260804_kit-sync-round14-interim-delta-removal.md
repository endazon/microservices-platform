...
（AI レビューの指摘）。実測したところ、**`planning#146` / `planning#149` / `planning#155` / `planning#160` / `planning#163` / `planning#168` の 6 件すべてについて、
同じ番号の無関係な PR / issue が本リポジトリにも実在**した。GitHub は裸の `#NNN` をそちらへ自動リンクする。
...
- **実測 run ID の列挙**（run 30829121373 / 30830151995 / 30832367628 / 30833943957）。
  実測の記録は `feedback/20260803_ai-review-execution-permissions.md`（環流記録。計画リポ `projects/microservices-platform/10_feedback/20260803_ai-review-execution-permissions.md` へ移設）
